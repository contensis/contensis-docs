...
Getting the [group](https://www.contensis.com/help-and-docs/apis/management-dotnet/model/group) memberships for a [user](https://www.contensis.com/help-and-docs/apis/management-dotnet/model/user) can be achived by using one of the `Groups` method overloads.
