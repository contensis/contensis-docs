...
Creating and updating [users](/help-and-docs/apis/management-dotnet/model/user) can be achieved by using one of the `New` method overloads in combination with calling `Save` on the User class.
