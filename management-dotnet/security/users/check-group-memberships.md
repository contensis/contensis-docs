...
Checking a [users](https://www.contensis.com/help-and-docs/apis/management-dotnet/model/user) group memberships can be achieved by using one of the `IsMemberOf` method overloads on the user object.
