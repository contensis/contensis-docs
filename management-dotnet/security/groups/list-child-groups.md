...
Listing the child [groups](https://www.contensis.com/help-and-docs/apis/management-dotnet/model/group) for a group can be achived by using one of the `Children` method overloads.
