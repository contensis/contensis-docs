...
If an order has been set for the sibling nodes then they will be returned in the defined order, otherwise they will be returned ordered by the created date ascending.