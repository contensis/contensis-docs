...
Expression Functions are built-in functions that can be used in search queries in place of static values in your [where operators](https://www.contensis.com/help-and-docs/apis/delivery-http/search-basics/query-operators). The functions generate a value when they are executed on the server by the API.
