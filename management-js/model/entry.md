...
Data properties are items defined by the [fields collection](about:/help-and-docs/apis/management-js/model/content-type#field) set in a content type.
...
Field data that is defined in the associated [content type](about:/help-and-docs/apis/management-js/model/content-type#field). The data is keyed by a unique field id.
