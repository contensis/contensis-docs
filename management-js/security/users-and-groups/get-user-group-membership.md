...
Gets the groups the user is a member of by passing the user id or a [UserGroupsOptions](/help-and-docs/apis/management-js/model/user-group-options) object as an argument.
