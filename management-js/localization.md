...
Contensis currently supports a subset of [language codes](https://www.contensis.com/help-and-docs/user-guides/authoring/entries/multi-language-support) which can be set when creating a project, and enabled against a content type.