...
4.  With the entry open for editing, change the language using the language switcher above the Site View tree. If the entry is available in the selected language, it will open alongside the default language entry in a split-view entry editor.
5.  Make your edits to the entry and press **Save** and **Submit** to send your content for approval, or **Publish** if the workflow allows you to publish the changes to the entry.
