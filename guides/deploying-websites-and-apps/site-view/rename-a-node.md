...
3.  Select **Node properties** from the menu. The node properties panel will be displayed.
4.  Make any required changes to the node.
5.  Press **Update** to save the changes, and the properties panel will close.

**Note:** Changing a parent/node slug will affect the resulting URL. The change will also affect any child nodes in your site structure. Changing about-us to about would affect all nodes that exist under it. For example, /about-us/our-ethos would become /about/our-ethos.