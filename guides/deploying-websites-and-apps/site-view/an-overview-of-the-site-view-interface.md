...
The Site View interface is split into three main areas – the tree, the listing, and the editor.
...
![](/image-library/resources-images/user-guides-images/site-view-tree.x731d5c76.png?q=80&f=webp)
...
1.  Select the **Action** button in the Site View header, indicated by a triple dot icon.
2.  Choose the **View by menu order** option from the menu. The content in the tree will be updated to reflect the selected order.
3.  To change the order back to alphabetical choose **View by alphabetical order** from the menu.
...
1.  Select the **Action** button in the Site View header, indicated by a triple dot icon.
2.  Select the **Collapse all** menu option.
3.  All the nodes in the tree will collapse.
...
1.  Select the **Action** button in the Site View header, indicated by a triple dot icon.
2.  Choose the **Refresh** option from the menu. The content in the tree will be refreshed ensuring you are viewing the latest changes.

## Listing

![](/image-library/resources-images/user-guides-images/site-view-listing.x13db8712.png?q=80&f=webp)
...
![](/image-library/resources-images/user-guides-images/site-view-editor.x429cdca8.png?q=80&f=webp)
