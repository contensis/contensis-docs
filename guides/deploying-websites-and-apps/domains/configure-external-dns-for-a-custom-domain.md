...
4.  [Domains](https://www.contensis.com/help-and-docs/guides/deploying-websites-and-apps/domains)
...
To point a subdomain such as `docs.yourdomain.com` or `www.yourdomain.com` to your project on Contensis, you must first [add the domain to your project](https://www.contensis.com/help-and-docs/guides/deploying-websites-and-apps/domains/add-and-update-a-domain) and then create a CNAME record with your DNS provider.

For example, if your site’s domain is `docs.yourdomain.com` and your alias is `alias.contensis.com`:

-   Follow the instructions to [add your domain](https://www.contensis.com/help-and-docs/guides/deploying-websites-and-apps/domains/add-and-update-a-domain) `docs.yourdomain.com` to your project.
