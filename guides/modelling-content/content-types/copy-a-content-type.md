If you find yourself needing to produce a content type that is very similar to an exisiting one, you can copy a content type from the content type builder. You'll need to be a member of the *Content type Administrators* security group to do this.

1.  Open the content type you want to copy by selecting it in the *Content type listing*.
2.  When the *Content type builder* opens, press the **Action** button from the content type toolbar.
