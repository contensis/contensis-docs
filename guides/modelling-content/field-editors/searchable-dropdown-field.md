...
![An example of a single selection made with the searchable dropdown field editor](/image-library/resources-images/user-guides-images/searchable-dropdown-single.xc4d1e118.png?q=80&f=webp)

An example of a single selection made with the searchable dropdown field editor

![An example of a multiple selection made with the searchable dropdown field editor](/image-library/resources-images/user-guides-images/searchable-dropdown-multiple.x5e8f812a.png?q=80&f=webp)
...
Allows an author to select multiple items in the tree.
...
The placeholder property provides a short hint describing the expected value of a field, in the case of the searchable dropdown this value will set the default text.
