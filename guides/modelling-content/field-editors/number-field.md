...
![](/image-library/resources-images/user-guides-images/number.xb0afeb62.png?q=80&f=webp)
...
The default value property sets the default content for a field when an entry is created. For example, a default number value of 500.
