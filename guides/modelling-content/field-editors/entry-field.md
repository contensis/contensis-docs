...
You can make single or multiple selections of entries and set the order. If you have the permissions to do so, you can also create and update entries inline from the entries displayed in the list.

## Appearance

![](/image-library/resources-images/user-guides-images/entry-single.x0bf3eec5.png?q=80&f=webp)

![](/image-library/resources-images/user-guides-images/entry-multiple.xf6418b36.png?q=80&f=webp)

![](/image-library/resources-images/user-guides-images/entry-tag.xc1ecbe22.png?q=80&f=webp)
...
Allows an author to select multiple entries.
