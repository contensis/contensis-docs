...
URL fields are designed to store web addresses, making them ideal for creating external links, adding to button components, or simply storing website URLs. These fields include built-in URL validation to ensure data accuracy. Additionally, URL fields can be displayed in the entry listing, allowing users to easily copy the field data to the clipboard.

## Appearance

![](/image-library/resources-images/user-guides-images/url-field.x0811556e.png?q=80&f=webp)
