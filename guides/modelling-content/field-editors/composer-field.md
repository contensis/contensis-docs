...
![An example of an empty composer field](/image-library/resources-images/user-guides-images/empty-composer.x2debfb38.png?q=80&f=webp)

An example of an empty composer field

![An example of a composer editor with fields added](/image-library/resources-images/user-guides-images/composer-fields-added.x3c5a9b26.png?q=80&f=webp)

An example of a composer editor with fields added
...
If you want to control who can arrange, or manage content of the supported fields you add to the composer, then you can apply [permissions](/help-and-docs/guides/governing-content/roles-and-permissions/composer-permissions-in-entries) in the roles builder.