...
-   [Saving a component](#saving-a-component)
-   [Publishing a component](#publishing-a-component)

All changes to a component are recorded in version history. The version number will depend on the [workflow state](/help-and-docs/user-guides/content-modelling/components/component-workflow-states) that the component is in. When a component is first created its version number will be *0.1*.
