...
1.  Press the **Component** field type in the *Toolbox.* A *Select a component* window will open, displaying a list of components that can be added to the content type.
