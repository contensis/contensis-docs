...
All users of Contensis need to have permissions to view part or all of the system files such as pages, images or documents. There are different types of permissions that can be set for each user.
