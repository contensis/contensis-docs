...
![](/image-library/resources-images/basic-workflow.xa842a2f2.png?q=80&f=webp)

#### Example

1.  An author creates an entry.
2.  They make multiple changes to the entry whilst in the *In progres*s state.
...
![](/image-library/resources-images/approval-workflow.x07622b9d.png?q=80&f=webp)
