...
Canvas is a content type field that enables authors to create long form content such as blogs, using a similar interface to Google Docs or Notion. One of the key differences is the Canvas content is returned as pure JSON rather than HTML.
...
![](/image-library/resources-images/user-guides-images/canvas-overview2.x44317b06.png?q=80&f=webp)
...
![](/image-library/resources-images/user-guides-images/canvas-display-mode-field1.x1d5a4d77.png?q=80&f=webp)
...
![](/image-library/resources-images/user-guides-images/canvas-display-mode-fullscreen1.x8829aca6.png?q=80&f=webp)
