...
![](/image-library/resources-images/user-guides-images/canvas-inserting-and-customising.xa8524333.png?q=80&f=webp)
...
1.  Select the Canvas from the toolbox. A configuration window will be displayed.
2.  By default, the *Kitchen Sink* preset is selected. This preset allows all current and future block types and decorators. Alternatively, you can uncheck the types and decorators you don’t wish to use.
3.  Select **Insert canvas** to confirm your selection and add the Canvas to the content type.
...
1.  Select the Canvas field in your content type. The *Settings* panel for the field will be displayed.
2.  From the Canvas configuration press **Configure**. the *Configuration* window will be displayed.
3.  Make any changes to the configuration and press **Save settings**.
...
External, entries, nodes, assets, anchors
