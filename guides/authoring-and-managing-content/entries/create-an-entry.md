...
4.  The fields in the *Entry editor* can now be populated. Press **Save** between any changes that have been made. The minor version will increment upon each save. Take a look at our [entry versioning](/help-and-docs/user-guides/authoring/entries/entry-versioning) article for details of how entries are versioned.
