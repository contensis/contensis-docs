...
1.  Update the name, email address or username of the user.
2.  Press **Save** in the toolbar to save your changes.

## User avatar

The user avatar is not editable from the CMS. It originates from the avatar used in the Contensis Slack community. If that's unavailable, the avatar is pulled from the Gravatar.com account associated with the email address. In the event a user does not have a profile image stored with either of these services, their initials will be displayed.
