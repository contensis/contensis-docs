...
Personalisation enables you to show the right content to the right people at the right time. It’s about tailoring your website so that different visitors see content that’s most relevant to them — based on things like where they are, what they’re interested in, or how they’ve interacted with your site before.

**Example:** On a university website, you might want prospective students from different countries to see course information that applies to them. Or you could highlight alumni stories for returning graduates.
...
1.  Contensis looks at their signals (clues about who they are — like their location or device).
2.  It matches them to an audience based on these signals.
3.  It shows them the version of your content that’s designed for that audience.
