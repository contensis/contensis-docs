...
6.  Choose the [topics and events](/help-and-docs/user-guides/integration/webhooks/webhook-topics-and-events) you want the webhook to be triggered by in the *Topics* section.
7.  Set any [headers](/help-and-docs/guides/integrating-with-other-platforms/webhooks/webhook-custom-headers) or [custom payloads](/help-and-docs/guides/integrating-with-other-platforms/webhooks/webhook-payloads) for the webhook request.
