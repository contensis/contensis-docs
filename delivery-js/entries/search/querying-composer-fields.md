...
With Contensis versions 14 and older, you can still search all the items in the composer field using the following search [operators](https://www.contensis.com/help-and-docs/apis/delivery-js/entries/search/query-operators):
