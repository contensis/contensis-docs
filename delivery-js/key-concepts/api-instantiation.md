...
Further [options](/help-and-docs/apis/delivery-js/model/config) can be set that are applied to all requests made from the [client](/help-and-docs/apis/delivery-js/model/client) instance
...
We have a  [Delivery API client](/help-and-docs/apis/delivery-js/model/client) connected to our CMS, all operations are available from within this client.
