...
An error occurred on the server. Something went wrong processing the request
...
The logId as a 128 bit GUID.  
This can be used within the Contensis [log search](https://zenhub.zengenti.com/contensis/contensis-cloud-classic/kb/tools-and-utilities/log-search/log-search-overview.aspx) to understand further details about the error
