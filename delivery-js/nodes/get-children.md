...
Call the nodes.getChildren() method in our delivery client to get the child nodes of an existing [node](/help-and-docs/apis/delivery-js/model/node) from site view, optionally resolving an attached [entry](/help-and-docs/apis/delivery-js/model/entry)
...
[NodeGetChildrenOptions](/help-and-docs/apis/delivery-js/model/node-get-children-options)
